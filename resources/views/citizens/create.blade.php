...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-4 border-bottom">
    <h1 class="h3 fw-bold text-dark" style="color: #0c2340 !important;">Register New Citizen</h1>
...
<div class="row">
                ...
                <form action="{{ route('citizens.store') }}" method="POST">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light @error('full_name') is-invalid @enderror" id="full_name" name="full_name" value="{{ old('full_name') }}" required>
                            @error('full_name')
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light @error('aadhaar_number') is-invalid @enderror" id="aadhaar_number" name="aadhaar_number" value="{{ old('aadhaar_number') }}" required maxlength="12" placeholder="12-digit format">
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light @error('mobile_number') is-invalid @enderror" id="mobile_number" name="mobile_number" value="{{ old('mobile_number') }}" required>
                            @error('mobile_number')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-4 mb-4">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control bg-light @error('date_of_birth') is-invalid @enderror" id="date_of_birth" name="date_of_birth" value="{{ old('date_of_birth') }}">
                            @error('date_of_birth')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light @error('state') is-invalid @enderror" id="state" name="state" value="{{ old('state') }}" required>
                            @error('state')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control bg-light @error('district') is-invalid @enderror" id="district" name="district" value="{{ old('district') }}">
                            @error('district')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-12">
                            ...
                            <textarea class="form-control bg-light @error('address') is-invalid @enderror" id="address" name="address" rows="3">{{ old('address') }}</textarea>
                            @error('address')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row g-4 mb-4">
                        <div class="col-md-6">
                            <label for="pension_status" class="form-label small fw-bold text-dark">Initial Pension Status <span class="text-danger">*</span></label>
                            <select class="form-select bg-light @error('pension_status') is-invalid @enderror" id="pension_status" name="pension_status" required>
                                ...
                                <option value="Pending" {{ old('pension_status') == 'Pending' ? 'selected' : '' }}>Pending Verification</option>
                                <option value="Eligible" {{ old('pension_status') == 'Eligible' ? 'selected' : '' }}>Eligible</option>
                                <option value="Not Eligible" {{ old('pension_status') == 'Not Eligible' ? 'selected' : '' }}>Not Eligible</option>
                                <option value="Active" {{ old('pension_status') == 'Active' ? 'selected' : '' }}>Active Pensioner</option>
                            </select>
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-4 pt-3 border-top">
                        ...
                        <button type="submit" class="btn btn-primary px-4 fw-medium shadow-sm" style="background-color: #0c2340; border-color: #0c2340;">
                            <i class="bi bi-save me-1"></i> Register Citizen
                        </button>
                    </div>
                </form>
            </div>
    ...
    <div class="col-lg-4">
        <div class="card shadow-sm border-0 border-top border-4 border-primary">
            <div class="card-body p-4">
                <h6 class="fw-bold text-dark mb-3">Guidelines</h6>
                <ul class="small text-muted ps-3 mb-0 lh-lg">
                    ...
                    <li>Pension Status should be "Pending" for unverified profiles.</li>
                </ul>
            </div>
        </div>
    </div>
